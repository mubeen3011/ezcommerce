...
$this->params['breadcrumbs'][] = 'Current Pricing Sheet';
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div id="example23_filter" class="dataTables_filter">
                                <button type="button" onclick="pageRedirect()" class=" btn btn-info" >
                    ...
                    <div style="padding: 15px;" class="pricing-index">
                        <div class="row grid-container">
                            <div id="example23_wrapper" class="table-parent" style="width:100%;">
                                ...
                                <table id="demo-foo-row-toggler" class="export-csv table toggle-circle table-hover default breakpoint footable-loaded footable table-striped table-bordered nowrap">
                                    <thead>
                                    <form>
                                        <tr>
                                            <th></th>
                                            ...
                                            <th  data-toggle="tooltip" title="Selling Status"  scope="col" data-tablesaw-priority="3" class="tg-kr94  ">
                                                <?=('Selling Status')?>
                                                <input type="text" id="selling_status" value="<?=isset($_GET['selling_status']) ? $_GET['selling_status'] : '' ?>" name="selling_status" class="min-th-width inputs-margin form-control filters-visible"></th>
                                            <th data-toggle="tooltip" title="Cost Price" scope="col" data-tablesaw-priority="5" class="tg-kr94  "><?=('Cost Price')?> <br />
                                            ...
                                            <?php foreach ($channelList as $cl): ?>
                                                ...
                                                <th data-toggle="tooltip" title="<?= $cl['name'] ?> - Lowest Price" scope="col" data-tablesaw-priority="<?=++$periority_counter?>" class="tg-kr94   chl-<?= $cl['name'] ?>">
                                                    <?= \backend\util\HelpUtil::ChannelPrefixByName($cl['name']).' - Lowest Price'?>
                                                    <input data-filter-type="operator" type="text" name="Channels[<?=$cl["id"]?>][low_price]" class="filters-visible inputs-margin min-th-width form-control" value="<?=isset($_GET['Channels'][$cl['id']]['low_price']) ? $_GET['Channels'][$cl['id']]['low_price'] : '' ?>"/></th>

                                                <!--<th data-toggle="tooltip" title="<?/*= $cl['name'] */?> - Margins at Lowest Price %" scope="col" data-tablesaw-priority="<?/*=++$periority_counter*/?>" class="tg-kr94   chl-<?/*= $cl['name'] */?>">
                                                    <?/*=\backend\util\HelpUtil::ChannelPrefixByName($cl['name']).' - Margins at Lowest Price %'*/?>
                                                ...
                                                <th data-toggle="tooltip" title="<?= $cl['name'] ?> - Sale Price" scope="col" data-tablesaw-priority="<?=++$periority_counter?>" class="tg-kr94   chl-<?= $cl['name'] ?>">
                                                    ...
                                                    <input data-filter-type="operator" type="text" name="Channels[<?=$cl["id"]?>][sale_price]" class="filters-visible form-control inputs-margin min-th-width" value="<?=isset($_GET['Channels'][$cl['id']]['sale_price']) ? $_GET['Channels'][$cl['id']]['sale_price'] : '' ?>"/></th>
                                    ...
                                    foreach ($skus as $key => $value) :?>
                                        <tr>
                                            <td class="footable-first-column">
                                                ...
                                                <a style="color: #54667a;" href="javascript:;" data-sku-id="<?=$value['sku']?>" data-row-status="closed" class=" show_more_information">
                                                    <i class="mdi mdi-plus-circle-outline" data-toggle="tooltip" title="" style="font-size: 29px" data-original-title="More info"></i>
                                                </a>
                                            </td>
                                            <td class="tg-kr94">
                                                <a style="color:blue" href="<?= \yii\helpers\Url::to(['/competitive-pricing/sku-details', 'sku' => $value['sku']]) ?>"><?= $value['sku'] ?></a>
                                            </td>
                                            ...
                                            <?php foreach ($channelList as $cl): ?>
                                                <?php if( !in_array($cl['id'],$user_columns) ){ continue; } ?>
                                                <td class="tg-kr94 chl-<?= $cl['name'] ?>"><?= isset($channelSkuList[$cl['id']][$key]['low_price']) ? $channelSkuList[$cl['id']][$key]['low_price'] : '' ?></td>
                                                ...
                                                <td class="tg-kr94 chl-<?= $cl['name'] ?>"><?= isset($channelSkuList[$cl['id']][$key]['sale_price']) ? $channelSkuList[$cl['id']][$key]['sale_price'] : '' ?></td>
