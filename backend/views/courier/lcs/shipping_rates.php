            ...
            <div class="row">
                <div class="col-sm-6 sm-6-shipping-rates">
                    <div class="input-group">
                        ...
                        <input type="number" value="<?= isset($dimensions['length']) ? $dimensions['length']:""; ?>" name="package_length" id="package_length" min="0" class="form-control-sm dm_inputs" placeholder="Length">
                        <input type="number"  value="<?= isset($dimensions['width']) ? $dimensions['width']:""; ?>" min="0" id="package_width" name="package_width" class="form-control-sm dm_inputs" placeholder="Width">
                        <input type="number" value="<?= isset($dimensions['height']) ? $dimensions['height']:""; ?>" min="0" id="package_height"name="package_height" class="form-control-sm dm_inputs" placeholder="Height">
                    </div>
                    <br>
                </div>
                <br>
