                                ...
                                <select class="form-control-sm"  name="shipper_city">
                                    ...
                                    <?php if(isset($cities)):
                                        foreach($cities as $city) {?>
                                            <option value="<?= $city->id;?>" <?= (isset($warehouse_address->city) && strtolower($warehouse_address->city)==strtolower($city->name)) ? "selected":"";?>>
                                                <?= $city->name;?>
                                            </option>
                                        <?php } ?>
                                    <?php endif;?>
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <select class="form-control-sm" id="cust_add_city" name="cust_city">
                                    ...
                                    <?php if(isset($cities)):
                                        foreach($cities as $city) {?>
                                    <option value="<?= $city->id;?>" <?= (isset($cust_address['city']) && (in_array(strtolower($cust_address['city']),[strtolower($city->name),strtolower($city->id)]))) ? "selected":"";?>>
                                            <?= $city->name;?>
                                    </option>
                                    <?php } ?>
                                    <?php endif;?>
