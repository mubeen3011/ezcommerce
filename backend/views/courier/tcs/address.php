            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" name="shipper_name" value="<?= isset($warehouse_address->display_name) ? $warehouse_address->display_name:"";?>" class="form-control-sm"  placeholder="Name">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" name="shipper_address" value="<?= isset($warehouse_address->address) ? $warehouse_address->address:"";?>"  class="form-control-sm"  placeholder="Address">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                <div class="input-group-prepend" data-toggle="tooltip" title="phone">
                                    <span class="input-group-text" id="basic-addon1">
                                        <i class="fa fa-phone"></i>
                                    </span>
                                </div>
                                <input type="text" name="shipper_phone" value="<?= isset($warehouse_address->phone) ? $warehouse_address->phone:"";?>"  class="form-control-sm"  placeholder="Phone">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" readonly  name="shipper_email" value="" class="form-control-sm"  placeholder="Email">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            ...
                            <span class="input-group-text" id="basic-addon1" >
                                ...
                                <input type="text" name="shipper_state"   value="<?= isset($warehouse_address->state) ? $warehouse_address->state:"";?>" class="form-control-sm" placeholder="State">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <select class="form-control-sm"  name="shipper_city">
                                    <option value="">--Choose City--</option>

                                    <?php if(isset($cities)):
                                        foreach($cities as $city) {?>
                                            <option value="<?= $city->cityID;?>" <?= (isset($warehouse_address->city) && strtolower($warehouse_address->city)==strtolower($city->cityName)) ? "selected":"";?>>
                                                <?= $city->cityName;?>
                                            </option>
                                        <?php } ?>
                                    <?php endif;?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input  type="text"  name="shipper_zip" value="<?= isset($warehouse_address->zipcode) ? $warehouse_address->zipcode:"";?>" class="form-control-sm"  placeholder="Zip">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" name="shipper_country" value="<?= isset($warehouse_address->country) ? $warehouse_address->country:"";?>" class="form-control-sm"  placeholder="Country">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" name="cust_name" value="<?= isset($cust_address['fname']) ? $cust_address['fname']:"";?>" class="form-control-sm"  placeholder="Name">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" name="cust_phone" value="<?= isset($cust_address['phone']) ? $cust_address['phone']:"";?>" class="form-control-sm"  placeholder="Phone">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" name="cust_email" value="<?= isset($cust_address['email']) ? $cust_address['email']:"";?>" class="form-control-sm"  placeholder="Email">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <select class="form-control-sm" id="cust_add_city" name="cust_city">
                                    <option value="">--Choose City--</option>
                                    <?php if(isset($cities)):
                                        foreach($cities as $city) {?>
                                    <option value="<?= $city->cityID;?>" <?= (isset($cust_address['city']) && (in_array(strtolower($cust_address['city']),[strtolower($city->cityName),strtolower($city->cityID)]))) ? "selected":"";?>>
                                            <?= $city->cityName;?>
                                    </option>
                                    <?php } ?>
                                    <?php endif;?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <a class="btn btn-success btn-sm validate_customer_address">Validate customer city</a>
                            </div>
                        </div>
