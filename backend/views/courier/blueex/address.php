                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" name="shipper_address" readonly  value="<?= isset($warehouse_address->address) ? $warehouse_address->address:"";?>"  class="form-control-sm"  placeholder="Address">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" name="shipper_phone" readonly  value="<?= isset($warehouse_address->phone) ? $warehouse_address->phone:"";?>"  class="form-control-sm"  placeholder="Phone">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" name="shipper_city"  readonly  value="<?= isset($warehouse_address->city) ? $warehouse_address->city:"";?>" class="form-control-sm" placeholder="City">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input  type="text" readonly  name="shipper_zip" value="<?= isset($warehouse_address->zipcode) ? $warehouse_address->zipcode:"";?>" class="form-control-sm"  placeholder="Zip">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" readonly  name="shipper_country" value="<?= isset($warehouse_address->country) ? $warehouse_address->country:"";?>" class="form-control-sm"  placeholder="Country">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <select class="form-control-sm" id="cust_add_city" name="cust_city">
                                    ...
                                    <option value="<?= $city->city_code->{0};?>" <?= (isset($cust_address['city']) && (in_array(strtolower($cust_address['city']),[strtolower($city->city_name->{0}),strtolower($city->city_code->{0})]))) ? "selected":"";?>>
                                            <?= $city->city_name->{0};?>
                                    </option>
                                    <?php } ?>
                                    <?php endif;?>
