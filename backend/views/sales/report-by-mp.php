...
$this->params['breadcrumbs'][] = 'Sales by Marketplace';
        ...
        <div class="card">
            <div class="card-body">
                <div class=" row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <h3 class="text-center"> <span class="fa fa-bar-chart"> </span> <?= strtoupper($mp);?></h3>
                    </div>
                    <div class="col-md-4 col-sm-12">
                ...
                <div class="card-body" style="height: auto !important;">
                    <h4 class="card-title">Sales by shop
                        ...
                        <?php if(isset($_GET['graph_filter_applied'])){ ?>
                            <a class="fa fa-filter text-danger" data-toggle="tooltip" title="Clear Filter" href="/sales/report-by-marketplace?mp=<?= $_GET['mp'];?>">
                            </a>
                        <?php } ?>
            ...
            <?php if(isset($sales_contribution['sales']) && !empty($sales_contribution['sales'])) : ?>
                <div class="row">
                    <div class="col-12">
                        <br>
                        <br>
                        <h4 class="card-title">Shops Summary</h4>
                                ...
                                <div class="card-body analytics-info">
                                    ...
                                    <div class="table-responsive">
                                        <table class="" style="width:100%">
                                            ...
                                            <tr>
                                                <td style="border-right:1px solid lightgray"><?= $currency. HelpUtil::number_format_short(round($platform_insight['sales']/$first_order['months_passed']),2);?></td>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body table-responsive">
                    <h4 class="card-title"><span class="fa fa-cart-plus"></span> Sales By Shops</h4>
            ...
            <div class="card-body" id="sales-by-cat-line-graph">
                ...
                <form action="/sales/sales-by-category/" role="form" class="form-horizontal sales_by_cat_filter_box" style="display:none">
                    <div class="row" >
                        ...
                        <div class="col-sm-4">
                           <input type="text"  name="filter_date" autocomplete="off" value="<?= date('Y-01-01') ." to " .date('Y-m-d');?>" class="form-control form-control-sm input-daterange-datepicker" placeholder="Date range">
                           <input type="hidden"  name="mp"  value="<?= $_GET['mp'];?>">
                        </div>
                        <div class="col-sm-2">
