...
$('#ci-search-brand').change(function () {
    if ($(this).val()!=''){
        $('#ci-search-form').submit();
    }
})

$('#ci-search-color').change(function () {
    if ($(this).val()!=''){
        $('#ci-search-form').submit();
    }
})
$('#ci-search-size').change(function () {
    if ($(this).val()!=''){
        $('#ci-search-form').submit();
    }
})
$('#ci-search-name').change(function () {
    if ($(this).val()!=''){
        $('#ci-search-form').submit();
    }
})
$('#ci-search-description').change(function () {
    if ($(this).val()!=''){
        $('#ci-search-form').submit();
    }
})
$('#ci-search-price').change(function () {
    if ($(this).val()!=''){
        $('#ci-search-form').submit();
    }
})
...
$('#ci-search-parentsku').change(function () {
    if ($(this).val()!=''){
        $('#ci-search-form').submit();
    }
})
